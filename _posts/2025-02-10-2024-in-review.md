  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        ...
        <li>
          <p><a href="https://www.cursor.com/">Cursor</a>: I haven't used much, but seems promising. I still don't think that 100% AI-generated code is a good idea, but it's definitely helpful. It seems smarter and a lot faster than Copilot. I used it for small projects where I knew exactly the code I wanted and it has worked well so far.
          </p>
        </li>
      </ul>
    </li>
...
{%
  include figure.html
    src="2024-in-review/streaming.webp"
    width="400"
%}
...
was also about ~25% more efficient.
