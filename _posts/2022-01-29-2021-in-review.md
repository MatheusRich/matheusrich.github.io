...
<div class="flex flex-wrap flex-center gap-4">
  {%
    include figure.html
      src="2021-in-review/superman.webp"
      width="300px"
  ...
  <div>
    {%
      include figure.html
        src="2021-in-review/planet.webp"
        width="300px"
    ...
    {%
      include figure.html
        src="2021-in-review/hollow-knight.webp"
        width="300px"
...
{%
  include figure.html
    src="2021-in-review/gaming.webp"
    width="800px"
...
{%
  include figure.html
    src="2021-in-review/webdev-parker.webp"
    width="800px"
...
{%
  include figure.html
    src="2021-in-review/maceio.webp"
    width="500px"
